...
export default function JobsPage() {
  ...
  const [apiKeyMissing, setApiKeyMissing] = useState(false) // We've configured the API key now
        ...
        {apiKeyMissing && (
          ...
          >
            <Alert variant="warning">
              ...
              <AlertDescription>
                The OpenRouter API model is invalid or unavailable. Some AI features like detailed job matching and
                cover letter generation will use fallback options.
              </AlertDescription>
            </Alert>
          </motion.div>
        )}
